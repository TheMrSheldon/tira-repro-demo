...
def run_experiment(indir: Path, outdir: Path):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-directory", "-i", required=True, type=Path)
    parser.add_argument("--output-directory", "-o", required=True, type=Path)
    args = parser.parse_args()

    run_experiment(args.input_directory, args.output_directory)